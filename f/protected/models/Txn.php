...
/**
 * This is the model class for table "txn".
 *
 * The followings are the available columns in table 'txn':
 * @property integer $id
 ...
 */
class Txn extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('cpc', 'length', 'max'=>45),
			array('timestamp', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, ad_id, widget_id, timestamp, ip_address, user_agent, cpc', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return Txn the static model class
	 */
