...
<head>
	...
	<link href="/assets/css/style_navygrey.css" rel="stylesheet" id="style_color"/>
			...
			<?php if(!app()->user->getIsGuest()): ?>
				...
				<li class="has-sub">
					...
					<ul class="sub">
						...
						<li menu-id="7"><a class="" href="<?= $bu ?>site/index">Add Fund</a></li>
						<li menu-id="8"><a class="" href="<?= $bu ?>site/index">Payments</a></li>
					</ul>
				</li>
			<?php endif; ?>
