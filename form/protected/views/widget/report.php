...
<div class="widget">
	<div class="widget-title">
		<h4><i class="icon-reorder"></i>Widgets reports</h4>
                           <span class="tools">
                           </span>
	</div>
	<div class="row-fluid">
...
<a class="fixwidth" href="/ce/widget/create">
	<button class="btn btn-warning"><i class="icon-plus icon-white"></i> Add Widget</button>
</a>
&nbsp;
<a href="#">
	...
	$(document).ready(function () {
		...
		$('#buttonExport').click(function () {
			highchartyw2.exportChart({
				...
				filename: 'widget-report-brax-pdf'
			}, {subtitle: {text: ''}});
		});
	});
</script>