...
?>
<h1>Website <?= app()->getRequest()->getQuery('role') ?> Report</h1>
...
<div class="widget">
	<div class="widget-title">
		<h4><i class="icon-reorder"></i>Website <?= app()->getRequest()->getQuery('role') ?> reports</h4>
                           <span class="tools">
                           </span>
	</div>
	<div class="row-fluid">
...
<a class="fixwidth" href="/ce/website/create">
	<button class="btn btn-warning"><i class="icon-plus icon-white"></i> Add Website</button>
</a>
&nbsp;
<a href="#">
	...
	$(document).ready(function () {
		...
		$('#buttonExport').click(function () {
			highchartyw2.exportChart({
				...
				filename: 'website-report-brax-pdf'
			}, {subtitle: {text: ''}});
		});
