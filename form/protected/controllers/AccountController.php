...
//			xdebug_break();
			...
			if($model->save())
			{
				...
				$user->save();
				mb_send_mail($user_email,'Account created','Welcome to BRAX/io! Your account has been created. <br/> User name: '. $user->username . ' password: '. $user->password, 'Content-Type: text/html');
