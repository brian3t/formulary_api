...
class Website extends CActiveRecord
{
	...
	public function relations()
	{
		...
		return array(
			'campaigns' => array(self::HAS_MANY, 'Campaign', 'website_id'),
			'placements' => array(self::HAS_MANY, 'Placement', 'website_id'),
			'account' => array(self::BELONGS_TO, 'Account', 'account_id'),
			'widgets' => array(self::HAS_MANY, 'Widget', 'website_id'),
		);
	}
